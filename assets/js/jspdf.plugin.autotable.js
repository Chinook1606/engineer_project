...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  typeof globalThis !== "undefined"
    ...
    ? self
    : global,
  function (__WEBPACK_EXTERNAL_MODULE__84__) {
    return /******/ (function () {
      // webpackBootstrap
      /******/ "use strict";
      /******/ var __webpack_modules__ = {
        ...
        /***/ 790: /***/ function (
          ...
          function default_1(jsPDF) {
            ...
            jsPDF.API.autoTableHtmlToJson = function (
              ...
              var _a = (0, htmlParser_1.parseHtml)(
                  doc,
                  tableElem,
                  window,
                  includeHiddenElements,
        ...
        /***/ 200: /***/ function (__unused_webpack_module, exports) {
          ...
          function parseSpacing(value, defaultValue) {
            ...
            if (typeof value === "object") {
              ...
              return {
                left:
                  (_a = value.left) !== null && _a !== void 0
                    ? _a
                    : defaultValue,
                top:
                  (_b = value.top) !== null && _b !== void 0
                    ? _b
                    : defaultValue,
                right:
          ...
          function parseCss(
            ...
            if (
              ...
              result.lineWidth = {
                ...
                right:
                  (parseFloat(style.borderRightWidth) || 0) / finalScaleFactor,
                bottom:
                  (parseFloat(style.borderBottomWidth) || 0) / finalScaleFactor,
                left:
                  (parseFloat(style.borderLeftWidth) || 0) / finalScaleFactor,
              };
        ...
        /***/ 323: /***/ function (__unused_webpack_module, exports) {
          ...
          var DocHandler = /** @class */ (function () {
            ...
            DocHandler.prototype.getLineHeight = function (fontSize) {
              return (
                (fontSize / this.scaleFactor()) * this.getLineHeightFactor()
              );
            };
                ...
                (_b =
                  (_a =
                    element === null || element === void 0
                      ? void 0
                      : element.parentElement) === null || _a === void 0
                    ? void 0
          ...
          function parseRowContent(
            ...
            for (var i = 0; i < row.cells.length; i++) {
              ...
              if (includeHidden || style_1.display !== "none") {
                ...
                if (useCss) {
                  cellStyles = (0, cssParser_1.parseCss)(
                    supportedFonts,
                    cell,
                    scaleFactor,
                    style_1,
            ...
            if (
              resultRow.length > 0 &&
              (includeHidden || style.display !== "none")
            ) {
              return resultRow;
            }
          }
        ...
        /***/ 587: /***/ function (
          ...
          function parseInput(d, current) {
            ...
            var options = (0, polyfills_1.assign)(
              {},
              global,
              document,
              current
          ...
          function parseStyles(gInput, dInput, cInput) {
            ...
            var _loop_1 = function (prop) {
              if (prop === "columnStyles") {
                ...
                styleOptions.columnStyles = (0, polyfills_1.assign)(
                  {},
                  global_1,
                  document_1,
                  current
                ...
                styleOptions[prop] = (0, polyfills_1.assign)(
                  {},
                  styles[0],
                  styles[1],
                  styles[2]
            ...
            for (
              var _i = 0, _a = Object.keys(styleOptions);
              _i < _a.length;
              _i++
            ) {
              var prop = _a[_i];
          ...
          function parseSettings(doc, options) {
            ...
            var margin = (0, common_1.parseSpacing)(
              options.margin,
              40 / doc.scaleFactor()
            );
            var startY =
              (_a = getStartY(doc, options.startY)) !== null && _a !== void 0
                ? _a
                : margin.top;
            var showFoot;
            if (options.showFoot === true) {
              ...
              showFoot =
                (_b = options.showFoot) !== null && _b !== void 0
                  ? _b
                  : "everyPage";
            }
            var showHead;
            if (options.showHead === true) {
              ...
              showHead =
                (_c = options.showHead) !== null && _c !== void 0
                  ? _c
                  : "everyPage";
            }
            var useCss =
              (_d = options.useCss) !== null && _d !== void 0 ? _d : false;
            var theme = options.theme || (useCss ? "plain" : "striped");
            var horizontalPageBreak = !!options.horizontalPageBreak;
            var horizontalPageBreakRepeat =
              (_e = options.horizontalPageBreakRepeat) !== null && _e !== void 0
                ? _e
                : null;
            return {
              includeHiddenHtml:
                (_f = options.includeHiddenHtml) !== null && _f !== void 0
                  ? _f
                  : false,
              useCss: useCss,
              theme: theme,
              ...
              margin: margin,
              pageBreak:
                (_g = options.pageBreak) !== null && _g !== void 0
                  ? _g
                  : "auto",
              rowPageBreak:
                (_h = options.rowPageBreak) !== null && _h !== void 0
                  ? _h
                  : "auto",
              tableWidth:
                (_j = options.tableWidth) !== null && _j !== void 0
                  ? _j
                  : "auto",
              showHead: showHead,
              showFoot: showFoot,
              tableLineWidth:
                (_k = options.tableLineWidth) !== null && _k !== void 0
                  ? _k
                  : 0,
              tableLineColor:
                (_l = options.tableLineColor) !== null && _l !== void 0
                  ? _l
                  : 200,
              horizontalPageBreak: horizontalPageBreak,
              horizontalPageBreakRepeat: horizontalPageBreakRepeat,
              horizontalPageBreakBehaviour:
                (_m = options.horizontalPageBreakBehaviour) !== null &&
                _m !== void 0
                  ? _m
                  : "afterAllRows",
            };
        ...
        /***/ 291: /***/ function (__unused_webpack_module, exports) {
          ...
          function default_1(doc, global, document, current) {
            var _loop_1 = function (options) {
                ...
                if (options[deprecated]) {
                  console.error(
                    "Use of deprecated option "
                      .concat(deprecated, ". Use ")
                      .concat(current, " instead")
                  );
              ...
              for (
                var _b = 0,
                  _c = ["styles", "bodyStyles", "headStyles", "footStyles"];
                _b < _c.length;
                _b++
              ) {
                var styleProp = _c[_b];
              ...
              for (
                var _d = 0, _e = Object.keys(columnStyles);
                _d < _e.length;
                _d++
              ) {
                var key = _e[_d];
            ...
            for (
              var _i = 0, _a = [global, document, current];
              _i < _a.length;
              _i++
            ) {
              var options = _a[_i];
          ...
          var Table = /** @class */ (function () {
            ...
            Table.prototype.callCellHooks = function (
              ...
              for (
                ...
                var data = new HookData_1.CellHookData(
                  doc,
                  this,
                  cell,
                  row,
            ...
            Table.prototype.callWillDrawPageHooks = function (doc, cursor) {
              for (
                var _i = 0, _a = this.hooks.willDrawPage;
                _i < _a.length;
                _i++
              ) {
                var handler = _a[_i];
          ...
          var Row = /** @class */ (function () {
            ...
            Row.prototype.getMaxCellHeight = function (columns) {
              ...
              return columns.reduce(function (acc, column) {
                ...
                return Math.max(
                  acc,
                  ((_a = _this.cells[column.index]) === null || _a === void 0
                    ? void 0
                    : _a.height) || 0
                );
              }, 0);
          ...
          var Cell = /** @class */ (function () {
            function Cell(raw, styles, section) {
              ...
              if (
                ...
                content =
                  (_b =
                    (_a = raw.content) !== null && _a !== void 0
                      ? _a
                      : raw.title) !== null && _b !== void 0
                    ? _b
                    : raw;
                if (raw._element) {
                  this.raw = raw._element;
            ...
            Cell.prototype.getContentHeight = function (
              ...
              var lineHeight =
                (this.styles.fontSize / scaleFactor) * lineHeightFactor;
              var height = lineCount * lineHeight + this.padding("vertical");
              return Math.max(height, this.styles.minCellHeight);
            };
            Cell.prototype.padding = function (name) {
              var padding = (0, common_1.parseSpacing)(
        ...
        /***/ 858: /***/ function (
          ...
          function createColumns(columns) {
            return columns.map(function (input, index) {
              ...
              if (typeof input === "object") {
                key =
                  (_b =
                    (_a = input.dataKey) !== null && _a !== void 0
                      ? _a
                      : input.key) !== null && _b !== void 0
                    ? _b
                    : index;
              } else {
                key = index;
          ...
          function cellStyles(
            ...
            var otherStyles = (0, polyfills_1.assign)(
              {},
              theme.table,
              theme[sectionName],
              styles.styles,
            ...
            var themeStyles = (0, polyfills_1.assign)(
              {},
              defaultStyle,
              otherStyles,
              rowStyles,
        ...
        /***/ 49: /***/ function (
          ...
          function printTableWithHorizontalPageBreak(
            ...
            var allColumnsCanFitResult = (0,
            tablePrinter_1.calculateAllColumnsCanFitInPage)(doc, table);
            var settings = table.settings;
            if (settings.horizontalPageBreakBehaviour === "afterAllRows") {
              ...
              var _loop_1 = function () {
                ...
                var maxNumberOfRows =
                  lastPrintedRowIndex - lastRowIndexOfLastPage_1;
                // Print the next columns, never exceding maxNumberOfRows
                allColumnsCanFitResult
                  .slice(1)
                  .forEach(function (colsAndIndexes) {
                    doc.applyStyles(doc.userStyles);
                    // When adding a page here, make sure not to print the footers
                    // because they were already printed before on this same loop
                    addPage(
          ...
          function printBodyWithoutPageBreaks(
            ...
            doc.applyStyles(doc.userStyles);
            maxNumberOfRows =
              maxNumberOfRows !== null && maxNumberOfRows !== void 0
                ? maxNumberOfRows
                : table.body.length;
            ...
            table.body
              ...
              .forEach(function (row, index) {
                ...
                var remainingSpace = getRemainingPageSpace(
                  doc,
                  table,
                  isLastRow,
                  cursor
          ...
          function shouldPrintOnCurrentPage(
            ...
            var rowHigherThanPage =
              row.getMaxCellHeight(table.columns) > maxRowHeight;
          ...
          function printFullRow(
            ...
            if (row.canEntireRowFit(remainingSpace, columns)) {
              ...
              shouldPrintOnCurrentPage(doc, row, remainingSpace, table)
            ) {
              // The row gets split in two here, each piece in one page
              var remainderRow = modifyRowToFit(
                row,
                remainingSpace,
                table,
                doc
          ...
          function printRow(doc, table, row, cursor, columns) {
            ...
            for (var _i = 0, columns_1 = columns; _i < columns_1.length; _i++) {
              ...
              cell.x = cursor.x;
              cell.y = cursor.y;
              var result = table.callCellHooks(
                doc,
          ...
          function drawCellRect(doc, cell, cursor) {
            ...
            if (typeof cellStyles.lineWidth === "number") {
              ...
              var fillStyle = (0, common_1.getFillStyle)(
        ...
        /***/ 435: /***/ function (
          ...
          function getColumnsCanFitInPage(doc, table, config) {
            ...
            // Get page width
            var remainingWidth = (0, common_1.getPageAvailableWidth)(
              doc,
              table
            );
            ...
            var i =
              (_a =
                config === null || config === void 0
                  ? void 0
                  : config.start) !== null && _a !== void 0
                ? _a
                : 0; // make sure couter is initiated outside the loop
          ...
          exports.calculateAllColumnsCanFitInPage =
        ...
        /***/ 189: /***/ function (
          ...
          function calculate(doc, table) {
            ...
            var availablePageWidth = (0, common_1.getPageAvailableWidth)(
              doc,
              table
            );
            table.allRows().forEach(function (row) {
              for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
                ...
                cell.contentWidth =
                  (0, common_1.getStringWidth)(cell.text, cell.styles, doc) +
                  padding;
                var longestWordWidth = (0, common_1.getStringWidth)(
              ...
              for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
                ...
                if (colRowSpansLeft > 1) {
                  ...
                  if (cell.rowSpan > 1) {
                    ...
                    var left =
                      cell.rowSpan > remaining ? remaining : cell.rowSpan;
          ...
          function ellipsizeStr(text, width, styles, doc, overflow) {
            ...
            while (
              width < (0, common_1.getStringWidth)(text + overflow, styles, doc)
            ) {
              if (text.length <= 1) {
                break;
              }
